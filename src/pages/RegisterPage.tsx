        ...
        <div className="relative min-h-[100dvh] w-full flex flex-col items-center justify-start overflow-x-hidden border-none outline-none bg-transparent font-mont-regular">
            ...
            <div className={`relative z-10 w-full flex flex-col items-center p-2 pb-32 transition-all duration-500 border-none ${loading ? 'blur-md pointer-events-none' : 'blur-0'}`}>
                ...
                <img
                    src="/logoballcc.png"
                    alt="Logo CC"
                    className="w-36 xs:w-44 sm:w-50 h-auto my-6 sm:my-6 object-contain"
                />
                ...
                <form
                    ...
                    className="bg-transparent border-2 border-white rounded-3xl p-4 sm:p-6 pt-4 w-[92%] xs:w-[90%] sm:max-w-md space-y-2 sm:space-y-3 mb-2"
                >
                    {/* Títulos */}
                    <div className="mb-2">
                        <h1 className="text-base xs:text-lg sm:text-xl text-start text-white font-mont-extrabold leading-tight">
                            1. REGÍSTRATE PARA PARTICIPAR
                        </h1>

                        <h2 className="text-start text-white font-mont-bold text-md xs:text-base sm:text-lg leading-tight tracking-tight mt-1">
                    ...
                    <div>
                        ...
                        <label className="block text-white text-base sm:text-lg font-mont-bold ml-1 mb-0.5">Nombres y apellidos</label>
                        <input
                            type="text"
                            name="name"
                            required
                            ...
                            maxLength={45}
                            className="bg-transparent border-2 border-white py-2 px-4 sm:p-3 w-full rounded-full text-white text-sm sm:text-base placeholder-black/70 focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors shadow-inner disabled:opacity-50"
                        />
                    </div>

                    <div>
                        {/* CAMBIO: text-base y ml-1 */}
                        <label className="block text-white text-base sm:text-lg font-mont-bold ml-1 mb-0.5">Número de DNI</label>
                        <input
                            type="text"
                            name="dni"
                            value={dni}
                    ...
                    <div>
                        {/* CAMBIO: text-base y ml-1 */}
                        <label className="block text-white text-base sm:text-lg font-mont-bold ml-1 mb-0.5">Teléfono</label>
                        <input
                            type="tel"
                            name="phone_number"
                            required
                    ...
                    <div>
                        {/* CAMBIO: text-base y ml-1 */}
                        <label className="block text-white text-base sm:text-lg font-mont-bold ml-1 mb-0.5">Foto de Voucher</label>
                        <div className="mt-0.5">
                            ...
                            <label
                                ...
                                className={`cursor-pointer flex items-center justify-center w-full py-2 sm:py-3 px-4 rounded-full border-2 border-white text-white font-mont-extrabold text-base sm:text-xl leading-none tracking-tight uppercase transition-colors ${loading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-black hover:text-white'}`}
                            >
                                SELECCIONAR ARCHIVO
                            </label>
                        </div>
                ...
                <div className="fixed bottom-4 left-0 right-0 px-6 z-20 flex justify-center pointer-events-none">
                    <button
                        ...
                        className="pointer-events-auto bg-white font-mont-bold rounded-full text-xl sm:text-2xl text-[#ec1d25] py-2 w-full max-w-[200px] shadow-2xl flex items-center justify-center disabled:opacity-0 hover:scale-105 transition-transform"
                    >
                        ENVIAR
                    </button>
                </div>
            ...
            {showTermsModal && (
                ...
                <div className="fixed inset-0  backdrop-blur-xl flex items-center justify-center z-50 p-4">
                    ...
                    <div className="bg-transparent text-white rounded-4xl p-5 sm:p-6 pt-4 w-full max-w-sm max-h-[80vh] flex flex-col relative shadow-xl border-3 border-black">
                        ...
                        <button
                            ...
                            className="absolute top-3 right-3 text-white hover:text-gray-800 transition-colors border border-2 rounded-full"
                        ...
                        <div className="flex-grow overflow-y-auto text-white text-[10px] sm:text-xs space-y-3 pb-4 pt-10 pr-1 leading-snug">
